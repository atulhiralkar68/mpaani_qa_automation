...
public class Page {
    ...
    public By findBy(YamlElement yamlElement){
        switch(yamlElement.findBy){
            case("id"):
                return MobileBy.id(yamlElement.locator);
            case("name"):
                return MobileBy.name(yamlElement.locator);
            case("css"):
                return MobileBy.cssSelector(yamlElement.locator);
            case("cssSelector"):
                return MobileBy.cssSelector(yamlElement.locator);
            case("linkText"):
                return MobileBy.linkText(yamlElement.locator);
            case("partialLinkText"):
                return MobileBy.partialLinkText(yamlElement.locator);
            case("xpath"):
                return MobileBy.xpath(yamlElement.locator);
            case("class"):
                return MobileBy.className(yamlElement.locator);
            case("className"):
                return MobileBy.className(yamlElement.locator);
            case("accessibility_id"):
            	return MobileBy.AccessibilityId(yamlElement.locator);
            case("iOSClassChain"):
            	return MobileBy.iOSClassChain(yamlElement.locator);
        }
